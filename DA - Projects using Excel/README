...
## 📊 Project Overview
This project features an interactive Excel Dashboard designed to analyze market trends, pricing strategies, and author performance within Amazon's "Top 100 Bestselling Books" over a 12-year period. The goal was to transform raw retail data into actionable business insights for publishing stakeholders.
...
2. **Standardization:** Grouped inconsistent cover types (e.g., "Mass Market Paperback") into clean categories.
3. **Handling Missing Values:** Purged rows with null titles or "unknown" genres to maintain data integrity.
4. **Outlier Removal:** Validated pricing and review counts for consistency.
